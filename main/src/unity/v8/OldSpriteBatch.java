...
public class OldSpriteBatch extends Batch {
     ...
     * @see #OldSpriteBatch(int, Shader)
     */
    public OldSpriteBatch(){
        this(4096, null);
    }
     ...
     * @see #OldSpriteBatch(int, Shader)
     */
    public OldSpriteBatch(int size){
        this(size, null);
    }
     ...
     */
    public OldSpriteBatch(int size, Shader defaultShader){
