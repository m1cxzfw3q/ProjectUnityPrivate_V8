...
public class BoostEndUnit extends Unit implements Drawc, Hitboxc, Itemsc, Commanderc, Endc, Weaponsc, Healthc, Builderc, Velc, Statusc, Entityc, Boostc, Physicsc, Flyingc, Posc, Rotc, Shieldc, Teamc, Unitc, Factionc, Boundedc, Minerc, Syncc {
    ...
    public float speed() {
        ...
        float boost = Mathf.lerp(1.0F, this.type.boostMultiplier, this.isPlayer() && ((Player)this.controller).boosting ? 1.0F : 0.0F);
    ...
    public static BoostEndUnit create() {
        return new BoostEndUnit();
    }

    public int classId() {
        return UnityEntityMapping.classId(BoostEndUnit.class);
    }
