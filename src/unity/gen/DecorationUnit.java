...
public class DecorationUnit extends Unit implements Statusc, Entityc, Drawc, Hitboxc, Physicsc, Itemsc, Flyingc, Shieldc, Posc, Commanderc, Syncc, Decorationc, Weaponsc, Teamc, Unitc, Healthc, Rotc, Boundedc, Builderc, Minerc, Velc {
    ...
    public static DecorationUnit create() {
        return new DecorationUnit();
    }

    public int classId() {
        return UnityEntityMapping.classId(DecorationUnit.class);
    }
