...
public interface Endc extends Statusc, Entityc, Drawc, Hitboxc, Physicsc, Itemsc, Flyingc, Shieldc, Posc, Commanderc, Syncc, Weaponsc, Teamc, Factionc, Unitc, Healthc, Rotc, Boundedc, Builderc, Minerc, Velc {
    float trueHealth();
