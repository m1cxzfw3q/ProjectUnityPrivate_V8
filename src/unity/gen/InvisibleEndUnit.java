...
public class InvisibleEndUnit extends Unit implements Drawc, Hitboxc, Itemsc, Commanderc, Endc, Weaponsc, Healthc, Builderc, Velc, Statusc, Entityc, Physicsc, Flyingc, Posc, Rotc, Shieldc, Invisiblec, Unintersectablec, Teamc, Unitc, Factionc, Boundedc, Minerc, Syncc {
    ...
    public String toString() {
        return "InvisibleEndUnit#" + this.id;
    }
    ...
    public static InvisibleEndUnit create() {
        return new InvisibleEndUnit();
    }

    public int classId() {
        return UnityEntityMapping.classId(InvisibleEndUnit.class);
    }
