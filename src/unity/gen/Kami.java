...
import unity.Unity;
import unity.ai.kami.KamiAI;
import unity.mod.Faction;

public class Kami extends Unit implements Drawc, Hitboxc, Itemsc, Kamic, Commanderc, Weaponsc, Healthc, Builderc, Velc, Statusc, Entityc, Physicsc, Flyingc, Posc, Rotc, Shieldc, Teamc, Unitc, Bossc, Factionc, Boundedc, Minerc, Syncc {
    ...
    public transient Bullet laser;
    public float laserRotation = 0.0F;
    private transient float laserRotation_TARGET_;
    private transient float laserRotation_LAST_;
    protected transient KamiAI newAI;
    ...
    public void snapInterpolation() {
        ...
        this.laserRotation_LAST_ = this.laserRotation;
        this.laserRotation_TARGET_ = this.laserRotation;
    ...
    public void snapSync() {
        this.updateSpacing = 16L;
        this.lastUpdated = Time.millis();
        this.laserRotation_LAST_ = this.laserRotation_TARGET_;
        this.laserRotation = this.laserRotation_TARGET_;
    ...
    public void add() {
        if (!this.added) {
            ...
            this.updateLastPosition();
            this.newAI = new KamiAI();
            this.newAI.unit(this);
            this.added = true;
            ...
            Unity.music.play(this.type.name, this::isValid);
        }
    }
    ...
    public void interpolate() {
        if (this.lastUpdated != 0L && this.updateSpacing != 0L) {
            ...
            this.laserRotation = Mathf.lerp(this.laserRotation_LAST_, this.laserRotation_TARGET_, alpha);
    ...
    public void update() {
        ...
        if (this.laser != null) {
            this.laser.rotation(this.laserRotation);
        }

        if (this.newAI.unit == this) {
            this.newAI.updateUnit();
        }
    ...
    public void readSyncManual(FloatBuffer buffer) {
        ...
        this.lastUpdated = Time.millis();
        this.laserRotation_LAST_ = this.laserRotation;
        this.laserRotation_TARGET_ = buffer.get();
        this.rotation_LAST_ = this.rotation;
    ...
    public void readSync(Reads read) {
        ...
        this.isShooting = read.bool();
        this.laserRotation_LAST_ = this.laserRotation;
        this.laserRotation_TARGET_ = read.f();
        if (!islocal) {
            this.mineTile = TypeIO.readTile(read);
        } else {
    ...
    public static Kami create() {
        return new Kami();
    }

    public int classId() {
        return UnityEntityMapping.classId(Kami.class);
    }
    ...
    public void laser(Bullet laser) {
        this.laser = laser;
    }

    public float laserRotation() {
        return this.laserRotation;
    }

    public void laserRotation(float laserRotation) {
