...
public class LegsEndUnit extends Unit implements Drawc, Hitboxc, Itemsc, Legsc, Commanderc, Endc, Weaponsc, Healthc, Builderc, Velc, Statusc, Entityc, Physicsc, Flyingc, Posc, Rotc, Shieldc, Teamc, Unitc, Factionc, Boundedc, Minerc, Syncc {
    ...
    public void update() {
        ...
        if (this.updateBuilding && this.canBuild()) {
            rot = Vars.state.rules.infiniteResources ? Float.MAX_VALUE : 220.0F;
            ...
            if (this.buildPlan() != null) {
                ...
                if (this.plans.size > 1) {
                    for(int total = 0; (!this.within((req = this.buildPlan()).tile(), rot) || this.shouldSkip(req, core)) && total < this.plans.size; ++total) {
    ...
    public static LegsEndUnit create() {
        return new LegsEndUnit();
    }

    public int classId() {
        return UnityEntityMapping.classId(LegsEndUnit.class);
    }
