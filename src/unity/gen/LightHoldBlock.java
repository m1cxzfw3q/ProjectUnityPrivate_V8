...
public class LightHoldBlock extends Block implements LightHoldc, Stemc {
    ...
    public class LightHoldBuild extends Building implements LightHoldc.LightHoldBuildc, Stemc.StemBuildc {
        ...
        public void draw() {
            ...
            LightHoldBlock.this.drawStem.get(this);
        }
        ...
        public void updateTile() {
            ...
            LightHoldBlock.this.updateStem.get(this);
        }
        ...
        public void created() {
            super.created();
            int len = LightHoldBlock.this.acceptors.size;
            this.slots = new LightAcceptor[len];

            for(int i = 0; i < len; ++i) {
                this.slots[i] = ((LightAcceptorType)LightHoldBlock.this.acceptors.get(i)).create(this);
            }
