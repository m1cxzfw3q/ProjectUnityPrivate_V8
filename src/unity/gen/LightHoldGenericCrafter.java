...
public class LightHoldGenericCrafter extends GenericCrafter implements LightHoldc, Stemc {
    ...
    public LightHoldGenericCrafter(String name) {
        super(name);
        this.update = true;
        this.sync = true;
    ...
    public class LightHoldGenericCrafterBuild extends GenericCrafter.GenericCrafterBuild implements LightHoldc.LightHoldBuildc, Stemc.StemBuildc {
        ...
        public LightHoldGenericCrafterBuild() {
            super(LightHoldGenericCrafter.this);
        }

        public String toString() {
            return "LightHoldGenericCrafterBuild#" + this.id;
        }
        ...
        public void draw() {
            ...
            LightHoldGenericCrafter.this.drawStem.get(this);
        }
        ...
        public void updateTile() {
            ...
            LightHoldGenericCrafter.this.updateStem.get(this);
        }
        ...
        public void created() {
            super.created();
            int len = LightHoldGenericCrafter.this.acceptors.size;
            this.slots = new LightAcceptor[len];

            for(int i = 0; i < len; ++i) {
                this.slots[i] = ((LightAcceptorType)LightHoldGenericCrafter.this.acceptors.get(i)).create(this);
            }
