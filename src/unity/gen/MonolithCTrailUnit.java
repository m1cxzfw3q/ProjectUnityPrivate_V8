...
public class MonolithCTrailUnit extends Unit implements Drawc, Hitboxc, CTrailc, Itemsc, Rotc, Commanderc, Weaponsc, Healthc, Builderc, Velc, Statusc, Entityc, Physicsc, Flyingc, Posc, Monolithc, Shieldc, Teamc, Unitc, Factionc, Boundedc, Minerc, Syncc {
    ...
    public static MonolithCTrailUnit create() {
        return new MonolithCTrailUnit();
    }

    public int classId() {
        return UnityEntityMapping.classId(MonolithCTrailUnit.class);
    }
