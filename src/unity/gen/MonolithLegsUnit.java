...
public class MonolithLegsUnit extends Unit implements Drawc, Hitboxc, Itemsc, Legsc, Rotc, Commanderc, Weaponsc, Healthc, Builderc, Velc, Statusc, Entityc, Physicsc, Flyingc, Posc, Monolithc, Shieldc, Teamc, Unitc, Factionc, Boundedc, Minerc, Syncc {
    ...
    public static MonolithLegsUnit create() {
        return new MonolithLegsUnit();
    }

    public int classId() {
        return UnityEntityMapping.classId(MonolithLegsUnit.class);
    }
