...
public class MonolithMechUnit extends Unit implements ElevationMovec, Drawc, Hitboxc, Itemsc, Rotc, Commanderc, Weaponsc, Mechc, Healthc, Builderc, Velc, Statusc, Entityc, Physicsc, Flyingc, Posc, Monolithc, Shieldc, Teamc, Unitc, Factionc, Boundedc, Minerc, Syncc {
    ...
    public static MonolithMechUnit create() {
        return new MonolithMechUnit();
    }

    public int classId() {
        return UnityEntityMapping.classId(MonolithMechUnit.class);
    }
