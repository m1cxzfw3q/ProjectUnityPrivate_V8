...
public interface Monolithc extends Soul, Statusc, Entityc, Drawc, Hitboxc, Physicsc, Itemsc, Flyingc, Shieldc, Posc, Commanderc, Syncc, Weaponsc, Teamc, Factionc, Unitc, Healthc, Rotc, Boundedc, Builderc, Minerc, Velc {
    boolean disabled();
}
