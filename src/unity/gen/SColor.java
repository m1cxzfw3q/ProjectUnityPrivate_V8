...
public final class SColor {
    ...
    public static float a(int scolor) {
        return (float)((int)((long)(scolor >>> 0) & 255L)) / 255.0F;
    }

    public static int a(int scolor, float value) {
        return (int)((long)scolor & -256L | (long)((int)(value * 255.0F) << 0));
    }

    public static float b(int scolor) {
        return (float)((int)((long)(scolor >>> 8) & 255L)) / 255.0F;
    }

    public static int b(int scolor, float value) {
        return (int)((long)scolor & -65281L | (long)((int)(value * 255.0F) << 8));
    }

    public static float g(int scolor) {
        return (float)((int)((long)(scolor >>> 16) & 255L)) / 255.0F;
    }

    public static int g(int scolor, float value) {
        return (int)((long)scolor & -16711681L | (long)((int)(value * 255.0F) << 16));
    }

    public static float r(int scolor) {
        return (float)((int)((long)(scolor >>> 24) & 255L)) / 255.0F;
    }

    public static int r(int scolor, float value) {
        return (int)((long)scolor & -4278190081L | (long)((int)(value * 255.0F) << 24));
    }
    ...
    public static int mulA(int scolor, float pa) {
        synchronized(STRUCT_LOCK) {
            STRUCT_LOCK.r = r(scolor);
            STRUCT_LOCK.g = g(scolor);
            STRUCT_LOCK.b = b(scolor);
            STRUCT_LOCK.a = a(scolor);
            return construct(STRUCT_LOCK.mulA(pa));
        }
    }
    ...
    public static int construct(float r, float g, float b, float a) {
        return (int)(a * 255.0F) << 0 | (int)(b * 255.0F) << 8 | (int)(g * 255.0F) << 16 | (int)(r * 255.0F) << 24;
    }
}
