...
public class SoulAbsorberTurret extends AbsorberTurret implements Soulc, Stemc {
    ...
    public class SoulAbsorberTurretBuild extends AbsorberTurret.AbsorberTurretBuild implements Soulc.SoulBuildc, Stemc.StemBuildc {
        @Nullable
        public transient BlockUnitc unit;
        private int souls;
        protected transient StemData data = new StemData();

        public SoulAbsorberTurretBuild() {
            super(SoulAbsorberTurret.this);
        }

        public String toString() {
            return "SoulAbsorberTurretBuild#" + this.id;
        }
        ...
        public void update() {
            SoulAbsorberTurret.this.progression.apply((float)this.souls);
            super.update();
        }
        ...
        public void updateTile() {
            super.updateTile();
            SoulAbsorberTurret.this.updateStem.get(this);
        }

        public int maxSouls() {
            return SoulAbsorberTurret.this.maxSouls;
        }
        ...
        public float efficiency() {
            float result = 1.0F;
            return SoulAbsorberTurret.this.requireSoul && this.disabled() ? 0.0F : super.efficiency() * result * ((float)this.souls / (float)SoulAbsorberTurret.this.maxSouls * (SoulAbsorberTurret.this.efficiencyTo - SoulAbsorberTurret.this.efficiencyFrom) + SoulAbsorberTurret.this.efficiencyFrom);
        }
        ...
        public void draw() {
            super.draw();
            SoulAbsorberTurret.this.drawStem.get(this);
        }
