...
import unity.world.blocks.production.FloorExtractor;
import unity.world.meta.DynamicProgression;
import unity.world.meta.StemData;

public class SoulFloorExtractor extends FloorExtractor implements Soulc, Stemc {
    ...
    public class SoulFloorExtractorBuild extends FloorExtractor.FloorExtractorBuild implements Soulc.SoulBuildc, Stemc.StemBuildc {
        @Nullable
        public transient BlockUnitc unit;
        private int souls;
        protected transient StemData data = new StemData();

        public SoulFloorExtractorBuild() {
            super(SoulFloorExtractor.this);
        }

        public String toString() {
            return "SoulFloorExtractorBuild#" + this.id;
        }
        ...
        public void update() {
            SoulFloorExtractor.this.progression.apply((float)this.souls);
            super.update();
        }
        ...
        public void updateTile() {
            super.updateTile();
            SoulFloorExtractor.this.updateStem.get(this);
        }

        public int maxSouls() {
            return SoulFloorExtractor.this.maxSouls;
        }
        ...
        public float efficiency() {
            float result = 1.0F;
            return SoulFloorExtractor.this.requireSoul && this.disabled() ? 0.0F : super.efficiency() * result * ((float)this.souls / (float)SoulFloorExtractor.this.maxSouls * (SoulFloorExtractor.this.efficiencyTo - SoulFloorExtractor.this.efficiencyFrom) + SoulFloorExtractor.this.efficiencyFrom);
        }
        ...
        public void draw() {
            super.draw();
            SoulFloorExtractor.this.drawStem.get(this);
        }
