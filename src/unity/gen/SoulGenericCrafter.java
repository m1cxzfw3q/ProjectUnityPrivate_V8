...
public class SoulGenericCrafter extends GenericCrafter implements Soulc, Stemc {
    ...
    public class SoulGenericCrafterBuild extends GenericCrafter.GenericCrafterBuild implements Soulc.SoulBuildc, Stemc.StemBuildc {
        @Nullable
        public transient BlockUnitc unit;
        private int souls;
        protected transient StemData data = new StemData();

        public SoulGenericCrafterBuild() {
            super(SoulGenericCrafter.this);
        }

        public String toString() {
            return "SoulGenericCrafterBuild#" + this.id;
        }
        ...
        public void update() {
            SoulGenericCrafter.this.progression.apply((float)this.souls);
            super.update();
        }
        ...
        public void updateTile() {
            super.updateTile();
            SoulGenericCrafter.this.updateStem.get(this);
        }

        public int maxSouls() {
            return SoulGenericCrafter.this.maxSouls;
        }
        ...
        public float efficiency() {
            float result = 1.0F;
            return SoulGenericCrafter.this.requireSoul && this.disabled() ? 0.0F : super.efficiency() * result * ((float)this.souls / (float)SoulGenericCrafter.this.maxSouls * (SoulGenericCrafter.this.efficiencyTo - SoulGenericCrafter.this.efficiencyFrom) + SoulGenericCrafter.this.efficiencyFrom);
        }
        ...
        public void draw() {
            super.draw();
            SoulGenericCrafter.this.drawStem.get(this);
        }
