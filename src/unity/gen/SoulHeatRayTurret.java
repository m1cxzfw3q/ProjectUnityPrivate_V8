...
import unity.world.blocks.defense.turrets.HeatRayTurret;
import unity.world.meta.DynamicProgression;
import unity.world.meta.StemData;

public class SoulHeatRayTurret extends HeatRayTurret implements Soulc, Stemc {
    ...
    public class SoulHeatRayTurretBuild extends HeatRayTurret.HeatRayTurretBuild implements Soulc.SoulBuildc, Stemc.StemBuildc {
        @Nullable
        public transient BlockUnitc unit;
        private int souls;
        protected transient StemData data = new StemData();

        public SoulHeatRayTurretBuild() {
            super(SoulHeatRayTurret.this);
        }

        public String toString() {
            return "SoulHeatRayTurretBuild#" + this.id;
        }
        ...
        public void update() {
            SoulHeatRayTurret.this.progression.apply((float)this.souls);
            super.update();
        }
        ...
        public void updateTile() {
            super.updateTile();
            SoulHeatRayTurret.this.updateStem.get(this);
        }

        public int maxSouls() {
            return SoulHeatRayTurret.this.maxSouls;
        }
        ...
        public float efficiency() {
            float result = 1.0F;
            return SoulHeatRayTurret.this.requireSoul && this.disabled() ? 0.0F : super.efficiency() * result * ((float)this.souls / (float)SoulHeatRayTurret.this.maxSouls * (SoulHeatRayTurret.this.efficiencyTo - SoulHeatRayTurret.this.efficiencyFrom) + SoulHeatRayTurret.this.efficiencyFrom);
        }
        ...
        public void draw() {
            super.draw();
            SoulHeatRayTurret.this.drawStem.get(this);
        }
