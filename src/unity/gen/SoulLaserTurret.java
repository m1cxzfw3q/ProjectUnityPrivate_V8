...
public class SoulLaserTurret extends LaserTurret implements Soulc, Stemc {
    ...
    public class SoulLaserTurretBuild extends LaserTurret.LaserTurretBuild implements Soulc.SoulBuildc, Stemc.StemBuildc {
        @Nullable
        public transient BlockUnitc unit;
        private int souls;
        protected transient StemData data = new StemData();

        public SoulLaserTurretBuild() {
            super(SoulLaserTurret.this);
        }

        public String toString() {
            return "SoulLaserTurretBuild#" + this.id;
        }
        ...
        public void update() {
            SoulLaserTurret.this.progression.apply((float)this.souls);
            super.update();
        }
        ...
        public void updateTile() {
            super.updateTile();
            SoulLaserTurret.this.updateStem.get(this);
        }

        public int maxSouls() {
            return SoulLaserTurret.this.maxSouls;
        }
        ...
        public float efficiency() {
            float result = 1.0F;
            return SoulLaserTurret.this.requireSoul && this.disabled() ? 0.0F : super.efficiency() * result * ((float)this.souls / (float)SoulLaserTurret.this.maxSouls * (SoulLaserTurret.this.efficiencyTo - SoulLaserTurret.this.efficiencyFrom) + SoulLaserTurret.this.efficiencyFrom);
        }
        ...
        public void draw() {
            super.draw();
            SoulLaserTurret.this.drawStem.get(this);
        }
