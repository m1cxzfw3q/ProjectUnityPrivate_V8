...
import unity.world.blocks.defense.turrets.LifeStealerTurret;
import unity.world.meta.DynamicProgression;
import unity.world.meta.StemData;

public class SoulLifeStealerTurret extends LifeStealerTurret implements Soulc, Stemc {
    ...
    public class SoulLifeStealerTurretBuild extends LifeStealerTurret.LifeStealerTurretBuild implements Soulc.SoulBuildc, Stemc.StemBuildc {
        @Nullable
        public transient BlockUnitc unit;
        private int souls;
        protected transient StemData data = new StemData();

        public SoulLifeStealerTurretBuild() {
            super(SoulLifeStealerTurret.this);
        }

        public String toString() {
            return "SoulLifeStealerTurretBuild#" + this.id;
        }
        ...
        public void update() {
            SoulLifeStealerTurret.this.progression.apply((float)this.souls);
            super.update();
        }
        ...
        public void updateTile() {
            super.updateTile();
            SoulLifeStealerTurret.this.updateStem.get(this);
        }

        public int maxSouls() {
            return SoulLifeStealerTurret.this.maxSouls;
        }
        ...
        public float efficiency() {
            float result = 1.0F;
            return SoulLifeStealerTurret.this.requireSoul && this.disabled() ? 0.0F : super.efficiency() * result * ((float)this.souls / (float)SoulLifeStealerTurret.this.maxSouls * (SoulLifeStealerTurret.this.efficiencyTo - SoulLifeStealerTurret.this.efficiencyFrom) + SoulLifeStealerTurret.this.efficiencyFrom);
        }
        ...
        public void draw() {
            super.draw();
            SoulLifeStealerTurret.this.drawStem.get(this);
        }
