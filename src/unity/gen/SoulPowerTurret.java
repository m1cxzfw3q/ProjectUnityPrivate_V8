...
public class SoulPowerTurret extends PowerTurret implements Soulc, Stemc {
    ...
    public SoulPowerTurret(String name) {
        super(name);
        this.update = true;
    ...
    public class SoulPowerTurretBuild extends PowerTurret.PowerTurretBuild implements Soulc.SoulBuildc, Stemc.StemBuildc {
        @Nullable
        public transient BlockUnitc unit;
        private int souls;
        protected transient StemData data = new StemData();

        public SoulPowerTurretBuild() {
            super(SoulPowerTurret.this);
        }

        public String toString() {
            return "SoulPowerTurretBuild#" + this.id;
        }
        ...
        public void update() {
            SoulPowerTurret.this.progression.apply((float)this.souls);
            super.update();
        }
        ...
        public void updateTile() {
            super.updateTile();
            SoulPowerTurret.this.updateStem.get(this);
        }

        public int maxSouls() {
            return SoulPowerTurret.this.maxSouls;
        }
        ...
        public float efficiency() {
            float result = 1.0F;
            return SoulPowerTurret.this.requireSoul && this.disabled() ? 0.0F : super.efficiency() * result * ((float)this.souls / (float)SoulPowerTurret.this.maxSouls * (SoulPowerTurret.this.efficiencyTo - SoulPowerTurret.this.efficiencyFrom) + SoulPowerTurret.this.efficiencyFrom);
        }
        ...
        public void draw() {
            super.draw();
            SoulPowerTurret.this.drawStem.get(this);
        }
