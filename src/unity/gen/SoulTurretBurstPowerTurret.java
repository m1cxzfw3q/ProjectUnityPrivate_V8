...
import unity.world.blocks.defense.turrets.BurstPowerTurret;
...
public class SoulTurretBurstPowerTurret extends BurstPowerTurret implements Soulc, Stemc, Turretc {
    ...
    public SoulTurretBurstPowerTurret(String name) {
        super(name);
    ...
    public class SoulTurretBurstPowerTurretBuild extends BurstPowerTurret.BurstPowerTurretBuild implements Soulc.SoulBuildc, Turretc.TurretBuildc, Stemc.StemBuildc {
        @Nullable
        public transient BlockUnitc unit;
        private int souls;
        protected transient StemData data = new StemData();

        public SoulTurretBurstPowerTurretBuild() {
            super(SoulTurretBurstPowerTurret.this);
        }

        public String toString() {
            return "SoulTurretBurstPowerTurretBuild#" + this.id;
        }
        ...
        public void effects() {
            if (this instanceof Expc.ExpBuildc && SoulTurretBurstPowerTurret.this.lerpColor) {
                Turret.TurretBuild exp = (Turret.TurretBuild)((Expc.ExpBuildc)this);
                this.recoil = SoulTurretBurstPowerTurret.this.recoilAmount;
                Effect shoot = SoulTurretBurstPowerTurret.this.shootEffect == Fx.none ? this.peekAmmo().shootEffect : SoulTurretBurstPowerTurret.this.shootEffect;
                Effect smoke = SoulTurretBurstPowerTurret.this.smokeEffect == Fx.none ? this.peekAmmo().smokeEffect : SoulTurretBurstPowerTurret.this.smokeEffect;
                shoot.at(this.x + SoulTurretBurstPowerTurret.this.tr.x, this.y + SoulTurretBurstPowerTurret.this.tr.y, this.rotation, this.getShootColor(((Expc.ExpBuildc)exp).levelf()));
                smoke.at(this.x + SoulTurretBurstPowerTurret.this.tr.x, this.y + SoulTurretBurstPowerTurret.this.tr.y, this.rotation);
                SoulTurretBurstPowerTurret.this.shootSound.at(this.x + SoulTurretBurstPowerTurret.this.tr.x, this.y + SoulTurretBurstPowerTurret.this.tr.y, Mathf.random(0.9F, 1.1F));
                if (SoulTurretBurstPowerTurret.this.shootShake > 0.0F) {
                    Effect.shake(SoulTurretBurstPowerTurret.this.shootShake, SoulTurretBurstPowerTurret.this.shootShake, this);
                }
            } else {
                super.effects();
            }
        ...
        public boolean hasAmmo() {
            if (this.self() instanceof LiquidTurret.LiquidTurretBuild && SoulTurretBurstPowerTurret.this.omni) {
        ...
        public void update() {
            SoulTurretBurstPowerTurret.this.progression.apply((float)this.souls);
            super.update();
        }

        public Object bulletData() {
            return SoulTurretBurstPowerTurret.this.bulletData.get(this);
        }

        public void drawSelect() {
            Drawf.dashCircle(this.x, this.y, SoulTurretBurstPowerTurret.this.range, SoulTurretBurstPowerTurret.this.rangeColor == null ? this.team.color : SoulTurretBurstPowerTurret.this.rangeColor);
        }
        ...
        public void updateTile() {
            super.updateTile();
            SoulTurretBurstPowerTurret.this.updateStem.get(this);
        }

        public int maxSouls() {
            return SoulTurretBurstPowerTurret.this.maxSouls;
        }
        ...
        public void shoot(BulletType type) {
            if (SoulTurretBurstPowerTurret.this.chargeTime > 0.0F && this instanceof Expc.ExpBuildc) {
                Turret.TurretBuild exp = (Turret.TurretBuild)((Expc.ExpBuildc)this);
                this.useAmmo();
                float lvl = ((Expc.ExpBuildc)exp).levelf();
                SoulTurretBurstPowerTurret.this.tr.trns(this.rotation, SoulTurretBurstPowerTurret.this.shootLength);
                SoulTurretBurstPowerTurret.this.chargeBeginEffect.at(this.x + SoulTurretBurstPowerTurret.this.tr.x, this.y + SoulTurretBurstPowerTurret.this.tr.y, this.rotation, this.getShootColor(lvl));
                SoulTurretBurstPowerTurret.this.chargeSound.at(this.x + SoulTurretBurstPowerTurret.this.tr.x, this.y + SoulTurretBurstPowerTurret.this.tr.y, 1.0F);

                for(int i = 0; i < SoulTurretBurstPowerTurret.this.chargeEffects; ++i) {
                    Time.run(Mathf.random(SoulTurretBurstPowerTurret.this.chargeMaxDelay), () -> {
                        if (this.isValid()) {
                            SoulTurretBurstPowerTurret.this.tr.trns(this.rotation, SoulTurretBurstPowerTurret.this.shootLength);
                            SoulTurretBurstPowerTurret.this.chargeEffect.at(this.x + SoulTurretBurstPowerTurret.this.tr.x, this.y + SoulTurretBurstPowerTurret.this.tr.y, this.rotation, this.getShootColor(lvl));
                        }
                ...
                for(int i = 0; i < SoulTurretBurstPowerTurret.this.shots; ++i) {
                    Time.run(SoulTurretBurstPowerTurret.this.burstSpacing * (float)i, () -> Time.run(SoulTurretBurstPowerTurret.this.chargeTime, () -> {
                        if (this.isValid()) {
                            SoulTurretBurstPowerTurret.this.tr.trns(this.rotation, SoulTurretBurstPowerTurret.this.shootLength, Mathf.range(SoulTurretBurstPowerTurret.this.xRand));
                            this.recoil = SoulTurretBurstPowerTurret.this.recoilAmount;
                            this.heat = 1.0F;
                            this.bullet(type, this.rotation + Mathf.range(SoulTurretBurstPowerTurret.this.inaccuracy));
                            this.effects();
                            this.charging = false;
                        }
        ...
        public float efficiency() {
            float result = 1.0F;
            return SoulTurretBurstPowerTurret.this.requireSoul && this.disabled() ? 0.0F : super.efficiency() * result * ((float)this.souls / (float)SoulTurretBurstPowerTurret.this.maxSouls * (SoulTurretBurstPowerTurret.this.efficiencyTo - SoulTurretBurstPowerTurret.this.efficiencyFrom) + SoulTurretBurstPowerTurret.this.efficiencyFrom);
        }

        public void draw() {
            super.draw();
            SoulTurretBurstPowerTurret.this.drawStem.get(this);
        }
        ...
        public BulletType peekAmmo() {
            ...
            if (var2 instanceof LiquidTurret) {
                ...
                if (SoulTurretBurstPowerTurret.this.omni) {
                    BulletType b = (BulletType)l.ammoTypes.get(this.liquids.current());
                    return b == null ? SoulTurretBurstPowerTurret.this.defaultBullet : b;
                }
            }
        ...
        public void bullet(BulletType type, float angle) {
            Bullet bullet = type.create(this, this.team, this.x + SoulTurretBurstPowerTurret.this.tr.x, this.y + SoulTurretBurstPowerTurret.this.tr.y, angle, type.damage, 1.0F + Mathf.range(SoulTurretBurstPowerTurret.this.velocityInaccuracy), type.scaleVelocity ? Mathf.clamp(Mathf.dst(this.x + SoulTurretBurstPowerTurret.this.tr.x, this.y + SoulTurretBurstPowerTurret.this.tr.y, this.targetPos.x, this.targetPos.y) / type.range(), SoulTurretBurstPowerTurret.this.minRange / type.range(), SoulTurretBurstPowerTurret.this.range / type.range()) : 1.0F, this.bulletData());
        ...
        public void bulletCons(BulletType type, Bullet b) {
            SoulTurretBurstPowerTurret.this.bulletCons.get(type, b);
        }

        public Color getShootColor(float progress) {
            return Tmp.c1.set(SoulTurretBurstPowerTurret.this.fromColor).lerp(SoulTurretBurstPowerTurret.this.toColor, progress).cpy();
        }
