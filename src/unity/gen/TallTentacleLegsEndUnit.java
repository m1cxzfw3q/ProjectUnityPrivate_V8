...
public class TallTentacleLegsEndUnit extends Unit implements Drawc, Hitboxc, Legsc, Rotc, Commanderc, Velc, Tallc, Flyingc, Teamc, Unitc, Factionc, Boundedc, Syncc, Itemsc, Tentaclec, Endc, Weaponsc, Healthc, Builderc, Statusc, Entityc, Physicsc, Posc, Shieldc, Minerc {
    ...
    protected TallTentacleLegsEndUnit() {
        this.applied = new Bits(Vars.content.getBy(ContentType.status).size);
    }

    public String toString() {
        return "TallTentacleLegsEndUnit#" + this.id;
    }
    ...
    public int pathType() {
        return this.type.allowLegStep ? 1 : 0;
    }
    ...
    public void resetLegs() {
        this.resetLegs(this.type.legLength);
    }
    ...
    public void update() {
        ...
        if (this.dead || this.health <= 0.0F) {
            ...
            if (Mathf.chanceDelta(0.2)) {
                ...
                this.type.fallThrusterEffect.at(this.x + Angles.trnsx(this.rotation + 180.0F, offset) + Mathf.range(legLength), this.y + Angles.trnsy(this.rotation + 180.0F, offset) + Mathf.range(legLength), Mathf.random());
            }
    ...
    public static TallTentacleLegsEndUnit create() {
        return new TallTentacleLegsEndUnit();
    }

    public int classId() {
        return UnityEntityMapping.classId(TallTentacleLegsEndUnit.class);
    }
    ...
    public void totalLength(float arg0) {
    ...
    public void moveSpace(float arg0) {
        this.moveSpace = this.moveSpace;
    }
    ...
    public void baseRotation(float arg0) {
        this.baseRotation = this.baseRotation;
    }
    ...
    public void lastDeepFloor(Floor arg0) {
        this.lastDeepFloor = this.lastDeepFloor;
    }
