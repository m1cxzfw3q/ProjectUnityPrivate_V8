...
public class Test extends Unit implements Drawc, Hitboxc, Itemsc, Commanderc, Test3c, Weaponsc, Healthc, Test4c, Builderc, Velc, Testc, Statusc, Test2c, Entityc, Physicsc, Flyingc, Posc, Rotc, Shieldc, Teamc, Unitc, Boundedc, Minerc, Syncc {
    ...
    public float speed() {
        float test2_speed_ = (float)this.hahaMine * 4.0F;
        ...
        float unit_speed_ = (this.isCommanding() ? this.minFormationSpeed * 0.98F : this.type.speed) * strafePenalty * boost * this.floorSpeedMultiplier();
        float result = test2_speed_ + unit_speed_;
        return result;
    }
    ...
    public void update() {
        if (this.shouldUpdate()) {
            ...
            if (this.shouldUpdateWeapons()) {
                this.updatePreWeaponsB();
                this.updatePreWeapons();

                for(WeaponMount mount : this.mounts) {
                    mount.weapon.update(this, mount);
                }

                this.updatePostWeaponsB();
                this.updatePostWeapons();
            }
            ...
            if (this.shouldUpdateUnit() && this.shouldUpdateUnitB()) {
            ...
            this.insertUpdateIfInheritsFromTest2();
            this.updatePost();
        }
    ...
    public void yourThing() {
        ...
        Log.info(this.hahaMine + ", beat that.");
    }
    ...
    public boolean serialize() {
        return Mathf.chance((double)this.chance);
    }
    ...
    public int classId() {
        return UnityEntityMapping.classId(Test.class);
    }
    ...
    public int hahaMine() {
        return this.hahaMine;
    }

    public void hahaMine(int hahaMine) {
        this.hahaMine = hahaMine;
    }
}
