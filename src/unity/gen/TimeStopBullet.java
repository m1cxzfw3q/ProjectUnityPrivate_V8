...
public class TimeStopBullet extends Bullet implements Pool.Poolable, Entityc, Drawc, Timedc, Ownerc, Posc, TimeStopBulletc, Hitboxc, Damagec, Bulletc, Teamc, Timerc, Shielderc, Velc {
    private transient boolean added;
    private float rotation;

    protected TimeStopBullet() {
    }

    public String toString() {
        return "TimeStopBullet#" + this.id;
    }
    ...
    public static TimeStopBullet create() {
        return (TimeStopBullet)Pools.obtain(TimeStopBullet.class, TimeStopBullet::new);
    }

    public int classId() {
        return UnityEntityMapping.classId(TimeStopBullet.class);
    }
}
