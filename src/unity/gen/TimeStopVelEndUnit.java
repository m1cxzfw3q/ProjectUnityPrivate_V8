...
public class TimeStopVelEndUnit extends Unit implements Drawc, Hitboxc, Itemsc, Commanderc, Endc, Weaponsc, Healthc, Builderc, Velc, Statusc, Entityc, Physicsc, Flyingc, Posc, Rotc, TimeStopVelc, Shieldc, Teamc, Unitc, Factionc, Boundedc, Minerc, Syncc {
    ...
    public void update() {
        ...
        if (this.updateVel() && (!Vars.net.client() || this.isLocal())) {
            float px = this.x;
            float py = this.y;
    ...
    public static TimeStopVelEndUnit create() {
        return new TimeStopVelEndUnit();
    }

    public int classId() {
        return UnityEntityMapping.classId(TimeStopVelEndUnit.class);
    }
