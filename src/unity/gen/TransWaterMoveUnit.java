...
public class TransWaterMoveUnit extends Unit implements Drawc, Hitboxc, Itemsc, Commanderc, Weaponsc, Healthc, Builderc, Velc, Statusc, Entityc, Physicsc, Flyingc, Posc, Rotc, Shieldc, Teamc, Unitc, WaterMovec, Transc, Boundedc, Minerc, Syncc {
    ...
    public String toString() {
        return "TransWaterMoveUnit#" + this.id;
    }
    ...
    public static TransWaterMoveUnit create() {
        return new TransWaterMoveUnit();
    }

    public int classId() {
        return UnityEntityMapping.classId(TransWaterMoveUnit.class);
    }
