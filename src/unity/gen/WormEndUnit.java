...
public class WormEndUnit extends Unit implements Drawc, Hitboxc, Itemsc, Commanderc, Endc, Weaponsc, Wormc, Healthc, Builderc, Velc, Statusc, Entityc, Physicsc, Flyingc, Posc, Rotc, Shieldc, Teamc, Unitc, Factionc, Boundedc, Minerc, Syncc {
    ...
    public void rotateMove(Vec2 vec) {
        ...
        if (!vec.isZero()) {
            this.rotation = Angles.moveToward(this.rotation, vec.angle(), this.type.rotateSpeed * (this.aggression + 1.0F) * Math.max(Time.delta, 1.0F));
        }
    ...
    public static WormEndUnit create() {
        return new WormEndUnit();
    }

    public int classId() {
        return UnityEntityMapping.classId(WormEndUnit.class);
    }
