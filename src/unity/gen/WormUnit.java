...
public class WormUnit extends Unit implements Statusc, Entityc, Drawc, Hitboxc, Physicsc, Itemsc, Flyingc, Shieldc, Posc, Commanderc, Syncc, Weaponsc, Teamc, Wormc, Unitc, Healthc, Rotc, Boundedc, Builderc, Minerc, Velc {
    ...
    public transient float layer;
    public transient float scanTime;
    public transient byte weaponIdx;
    public transient boolean removing;
    public transient boolean saveAdd;
    ...
    public void write(Writes write) {
        ...
        if (this.isHead()) {
            ...
            for(Wormc var6 = (Wormc)this.child; var6 != null; var6 = (Wormc)var6.child()) {
    ...
    public static WormUnit create() {
        return new WormUnit();
    }

    public int classId() {
        return UnityEntityMapping.classId(WormUnit.class);
    }
